    ...
    <div id="load-show">
        <el-row :gutter="25">
            <el-col :span="4" :offset="5">
                <div class="sidebar-author">
                    ...
                    <dl class="dl-horizontal">
                        ...
                        <div class="df" v-if="user.real_name">
                            <dt><label>Real Name:</label></dt><dd><span>{{ user.real_name }}</span></dd>
                        </div>
                        <div class="df" v-if="user.city">
                            <dt><label>City:</label></dt><dd><span><i class="text-md fa fa-map-marker"></i> {{ user.city }}</span></dd>
                        </div>
                        <div class="df">
                ...
                <div class="user-info">
                    <ul class="reply">
                        <li><router-link :to="{name: 'UserArticles', params: {slug: user.id}}">
                            <i class="text-md fa fa-list-ul"></i>  Ta 发布的话题
                        </router-link></li>
                        <li><router-link :to="{name: 'UserReplies', params: {slug: user.id}}">
                            <i class="text-md fa fa-comment"></i>  Ta 发表的回复
                        </router-link></li>
                        <li><router-link :to="{name: 'UserLikesUsers', params: {slug: user.id}}">
                            <i class="text-md fa fa-eye"></i>  Ta 关注的用户
                        </router-link></li>
                        <li><router-link :to="{name: 'UserLikesArticles', params: {slug: user.id}}">
